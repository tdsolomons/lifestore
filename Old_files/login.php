...
<div style="background-image:url(images/sdd.png);height:120px;">
  <div style="margin:30px auto auto 60px;background-image:url(images/logo1.png);width:260px;height:65px;position:absolute ; "></div>
