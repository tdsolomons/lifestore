...
<div class="container table-bordered" style="width:800px;height:400px;margin-top:50px;margin-bottom:100px">
        ...
        <div class="container" style="width:600px;height:100px;margin-top:20px;text-align:center;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif"><h2>Forgot Password ?</h2></div>
    
        <div class="container" style="margin-top:10px;width:400px;height:200px">
            <form role="form" action="http://sep.tagfie.com/Login/forgotPasswordSubmit" method="post">
                    ...
                    <button type="submit" class="btn btn-default">Send Email</button> To me
                     </br>
                     </br>
                     <a href="http://sep.tagfie.com/Login/login"><button type="button" class="btn btn-default ">Back</button></a> To login
