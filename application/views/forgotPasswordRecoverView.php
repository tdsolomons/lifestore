...
<div class="container table-bordered" style="width:800px;height:500px;margin-top:50px;margin-bottom:100px">
        ...
        <div class="container" style="width:600px;height:70px;margin-top:20px;text-align:center;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif"><h2>Reset Password Here</h2></div>
    
        <div class="container" style="margin-top:10px;width:400px;height:350px">
            <form role="form" action="http://sep.tagfie.com/Login/passwordForgotValidate" method="post">
                     
                      <div class="form-group">
                     <label for="upassword">New Password:</label>
                     <span style="color:#F00;font-size:12px"><?php echo form_error('password'); ?></span>
                     <input type="password" class="form-control"  name="upassword" id="password" placeholder="" value="<?php echo set_value('password'); ?>">
                    </div>             
                    ...
                    <div class="form-group col-md-8" style="padding-left:0px;margin-left:0px;margin-top:10px;" > 
                     ...
                     <a href="http://sep.tagfie.com/Login/login"><button type="button" class="btn btn-default ">Back</button></a>
                    </div>
