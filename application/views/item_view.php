...
<label style="background:#CCC;"></label><br>
	<input type="hidden" id="item_id" name="item_id" value="<?php echo $itemObject->item_id ?>" >
...
<div id="seller_details">
	...
	echo '<a = href="'. base_url() .'Messages/sendForm/?to='. $itemObject->username .'&item='. $itemObject->item_id .'" >Contact Seller</a></br></br>';
	?>
</div>
