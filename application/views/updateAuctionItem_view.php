...
<div class="container">
    ...
    <div class="row"  style="min-height:800px;">
               ...
               <div style="margin-top:10px;margin-left:30px;width:400px;height:200px">
                    <form role="form" action="http://sep.tagfie.com/Upload/update_auction_item" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                             ...
                             <input type="text" class="form-control"  name="s_price" value="<?php echo set_value('s_price',$starting_bid); ?>" id="s_price" placeholder="">
                            </div>
                             
                             <div class="form-group">
                             <label for="minBid">Minimum Bidding Amount:</label>
                             <span style="color:#F00;font-size:12px"><?php echo form_error('minBid'); ?></span>
                             <input type="text" class="form-control"  name="minBid" value="<?php echo set_value('minBid',$minimum_increment); ?>" id="minBid" placeholder="">
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <input type="text" class="form-control"  name="e_date" value="<?php echo set_value('e_date',$end_datetime); ?>" id="e_date" placeholder="">
                            </div>
                             ...
                             <input type="text" class="form-control"  name="cost" id="cost" value="<?php echo set_value('cost',$shcos); ?>" placeholder="">
                            </div>             
